            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr>
                  ...
                  <th className="p-6 text-xl font-bold text-white bg-stone-800/50 border-t-4 border-gold-500 rounded-t-xl">Custom Counters LLC</th>
                  <th className="p-6 text-lg font-medium text-stone-400 border-b border-stone-800 w-1/3">Big Box Retailers</th>
                </tr>
              </thead>
